...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/cargo-zigbuild/security/advisories/new)
...
- This repository (`hyperpolymath/cargo-zigbuild`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/cargo-zigbuild/security/advisories)
...
When using cargo-zigbuild, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/cargo-zigbuild/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/cargo-zigbuild/security/advisories/new) or jonathan.jewell@gmail.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/cargo-zigbuild/discussions) |
...
*Thank you for helping keep cargo-zigbuild and its users safe.* 🛡️
